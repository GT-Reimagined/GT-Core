...
import org.gtreimagined.gtcore.client.model.RedstoneWireModelLoader;
...
public class BakedModels {
    ...
    public static final ResourceLocation LOADER_REDSTONE_WIRE = new ResourceLocation(GTCore.ID, "redstone_wire");
    ...
    public static void init() {
        ...
        new RedstoneWireModelLoader(LOADER_REDSTONE_WIRE);
