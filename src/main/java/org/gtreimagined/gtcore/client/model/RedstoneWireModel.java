...
public class RedstoneWireModel implements IGTModel<RedstoneWireModel> {
    ...
    public RedstoneWireModel(UnbakedModel base, UnbakedModel baseEnd, UnbakedModel[] connections, UnbakedModel[] connectionsEnd, ResourceLocation particle) {
        this.base = base;
    ...
    public BakedModel bakeModel(IGeometryBakingContext configuration, ModelBaker bakery, Function<Material, TextureAtlasSprite> getter, ModelState transform, ItemOverrides overrides, ResourceLocation loc) {
        ...
        return new RedstoneWireBakedModel(getter.apply(new Material(TextureAtlas.LOCATION_BLOCKS, particle)), base.bake(bakery, getter, transform, loc), baseEnd.bake(bakery, getter, transform, loc), connections, connectionsEnd);
    }
