...
public class RedstoneWireModelLoader extends GTModelLoader<RedstoneWireModel> {
    public RedstoneWireModelLoader(ResourceLocation loc) {
        super(loc);
    }

    @Override
    public RedstoneWireModel read(JsonObject json, JsonDeserializationContext context) throws JsonParseException {
        ...
        return new RedstoneWireModel(base, baseEnd, connections, connectionsEnd, particle);
    }
}
