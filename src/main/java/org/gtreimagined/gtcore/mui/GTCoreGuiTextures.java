...
public class GTCoreGuiTextures {
    ...
    public static final UITexture BRONZE_BACKGROUND = UITexture.fullImage(GTCore.ID, "textures/gui/background/bronze.png");
    public static final UITexture STEEL_BACKGROUND = UITexture.fullImage(GTCore.ID, "textures/gui/background/steel.png");
    public static final UITexture PRIMITIVE_BACKGROUND = UITexture.fullImage(GTCore.ID, "textures/gui/background/primitive.png");
    ...
    public static final UITexture BRONZE_ITEM_SLOT = UITexture.fullImage(GTCore.ID, "textures/gui/slots/item_bronze.png");
    public static final UITexture STEEL_ITEM_SLOT = UITexture.fullImage(GTCore.ID, "textures/gui/slots/item_steel.png");
    public static final UITexture PRIMITIVE_ITEM_SLOT = UITexture.fullImage(GTCore.ID, "textures/gui/slots/item_primitive.png");
    public static final UITexture BRONZE_FLUID_SLOT = UITexture.fullImage(GTCore.ID, "textures/gui/slots/fluid_bronze.png");
    public static final UITexture STEEL_FLUID_SLOT = UITexture.fullImage(GTCore.ID, "textures/gui/slots/fluid_steel.png");
    public static final UITexture PRIMITIVE_FLUID_SLOT = UITexture.fullImage(GTCore.ID, "textures/gui/slots/fluid_primitive.png");
