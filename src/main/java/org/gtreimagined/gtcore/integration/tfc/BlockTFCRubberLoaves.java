...
public class BlockTFCRubberLoaves extends TFCLeavesBlock implements IGTObject, ITextureProvider, IModelProvider {
    ...
    public BlockTFCRubberLoaves() {
        super(ExtendedProperties.of(MapColor.PLANT).ignitedByLava().pushReaction(PushReaction.DESTROY).strength(0.5F).sound(SoundType.GRASS).randomTicks().noOcclusion().isViewBlocking(TFCBlocks::never).flammableLikeLeaves(), 7, () -> TFCRubberData.RUBBER_FALLEN_LEAVES, () -> TFCRubberData.RUBBER_TWIG);
